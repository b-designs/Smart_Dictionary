...
export default function Page() {
  return (
    <main>
      <h1 className={"mt-4 text-black-700"}>Results for blood...</h1>
      <div className="border border-gray-200 p-4 my-4">
        <div className="flex justify-between">
          {/* English Definition */}
          <div className="w-1/2 pr-4">
            <h2 className="text-3xl text-emerald-500 justify-left p-2">Blood</h2>
            <p className="justify-left p-2">The red liquid that circulates in the arteries and veins of humans and other vertebrate animals, carrying oxygen to and carbon dioxide from the tissues of the body.
            </p>
          </div>
          {/* Spanish Definition */}
          <div className="w-1/2 pl-4">
          <h2 className="text-3xl text-emerald-500 justify-left p-2">Sangre</h2>
            <p className="justify-left p-2">
